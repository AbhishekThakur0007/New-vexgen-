...
>
    ...
    @push('css')
        <style>
            /* Global Search Bar Styling - Theme Matching */
            body[data-theme="marketing-bot-dashboard"] .header-search-input,
            body[data-theme="marketing-bot-dashboard"] .navbar-search-input,
            body[data-theme="marketing-bot-dashboard"] .chats-search-form input,
            body[data-theme="marketing-bot-dashboard"] input[type="search"],
            body[data-theme="marketing-bot-dashboard"] .lqd-generator-search-form input,
            body[data-theme="marketing-bot-dashboard"] .lqd-users-search-input,
            body[data-theme="marketing-bot-dashboard"] .lqd-marketplace-search-input {
            ...
            body[data-theme="marketing-bot-dashboard"] .navbar-search-input:focus,
            body[data-theme="marketing-bot-dashboard"] .chats-search-form input:focus,
            body[data-theme="marketing-bot-dashboard"] input[type="search"]:focus,
            body[data-theme="marketing-bot-dashboard"] .lqd-generator-search-form input:focus,
            body[data-theme="marketing-bot-dashboard"] .lqd-users-search-input:focus,
            body[data-theme="marketing-bot-dashboard"] .lqd-marketplace-search-input:focus {
            ...
            body[data-theme="marketing-bot-dashboard"] .navbar-search-input::placeholder,
            body[data-theme="marketing-bot-dashboard"] .chats-search-form input::placeholder,
            body[data-theme="marketing-bot-dashboard"] input[type="search"]::placeholder,
            body[data-theme="marketing-bot-dashboard"] .lqd-generator-search-form input::placeholder {
                color: rgba(255, 255, 255, 0.5) !important;
            }

            /* Search Icon Styling - Modern Glow Effects */
            body[data-theme="marketing-bot-dashboard"] .header-search-icon,
            body[data-theme="marketing-bot-dashboard"] .chats-search-form svg,
            body[data-theme="marketing-bot-dashboard"] .navbar-search-input + svg,
            body[data-theme="marketing-bot-dashboard"] input[type="search"] + svg,
            body[data-theme="marketing-bot-dashboard"] .lqd-generator-search-form svg {
                filter: drop-shadow(0 0 8px rgba(0, 212, 255, 0.6));
                transition: all 0.3s ease;
                color: rgba(0, 212, 255, 0.8) !important;
            }

            body[data-theme="marketing-bot-dashboard"] .header-search-input:focus ~ .header-search-icon,
            body[data-theme="marketing-bot-dashboard"] .navbar-search-input:focus + svg,
            body[data-theme="marketing-bot-dashboard"] .chats-search-form input:focus + svg {
                filter: drop-shadow(0 0 12px rgba(0, 212, 255, 0.9));
                transform: scale(1.1);
                color: rgba(0, 212, 255, 1) !important;
            }

            /* Global Modern Icons Styling - All Pages */
            body[data-theme="marketing-bot-dashboard"] svg:not(.no-glow),
            body[data-theme="marketing-bot-dashboard"] .lqd-icon:not(.no-glow),
            body[data-theme="marketing-bot-dashboard"] [class*="icon"]:not(.no-glow) {
                filter: drop-shadow(0 0 6px rgba(0, 212, 255, 0.4));
                transition: all 0.3s ease;
            }

            /* Icon Hover Effects */
            body[data-theme="marketing-bot-dashboard"] .lqd-btn:hover svg:not(.no-glow),
            body[data-theme="marketing-bot-dashboard"] button:hover svg:not(.no-glow),
            body[data-theme="marketing-bot-dashboard"] a:hover svg:not(.no-glow),
            body[data-theme="marketing-bot-dashboard"] .lqd-card:hover svg:not(.no-glow) {
                filter: drop-shadow(0 0 12px rgba(0, 212, 255, 0.8));
                transform: scale(1.1);
            }

            /* Tabler Icons Modern Styling */
            body[data-theme="marketing-bot-dashboard"] .tabler-icon:not(.no-glow) {
                filter: drop-shadow(0 0 6px rgba(0, 212, 255, 0.4));
                transition: all 0.3s ease;
            }

            body[data-theme="marketing-bot-dashboard"] .lqd-btn:hover .tabler-icon:not(.no-glow),
            body[data-theme="marketing-bot-dashboard"] button:hover .tabler-icon:not(.no-glow) {
                filter: drop-shadow(0 0 12px rgba(0, 212, 255, 0.8));
                transform: scale(1.1);
            }

            /* Action Icons - Enhanced Glow */
            body[data-theme="marketing-bot-dashboard"] .lqd-btn[class*="primary"] svg,
            body[data-theme="marketing-bot-dashboard"] .lqd-btn[class*="secondary"] svg {
                filter: drop-shadow(0 0 8px rgba(0, 212, 255, 0.6));
            }

            body[data-theme="marketing-bot-dashboard"] .lqd-btn[class*="primary"]:hover svg,
            body[data-theme="marketing-bot-dashboard"] .lqd-btn[class*="secondary"]:hover svg {
                filter: drop-shadow(0 0 15px rgba(0, 212, 255, 0.9));
                transform: scale(1.15);
            }

            /* Navigation Icons */
            body[data-theme="marketing-bot-dashboard"] .lqd-navbar svg,
            body[data-theme="marketing-bot-dashboard"] .lqd-header svg {
                filter: drop-shadow(0 0 5px rgba(0, 212, 255, 0.4));
                transition: all 0.3s ease;
            }

            body[data-theme="marketing-bot-dashboard"] .lqd-navbar a:hover svg,
            body[data-theme="marketing-bot-dashboard"] .lqd-header button:hover svg {
                filter: drop-shadow(0 0 10px rgba(0, 212, 255, 0.7));
                transform: scale(1.1);
            }

            /* Table Action Icons */
            body[data-theme="marketing-bot-dashboard"] .lqd-table svg,
            body[data-theme="marketing-bot-dashboard"] table svg {
                filter: drop-shadow(0 0 6px rgba(0, 212, 255, 0.5));
            }

            body[data-theme="marketing-bot-dashboard"] .lqd-table button:hover svg,
            body[data-theme="marketing-bot-dashboard"] table button:hover svg {
                filter: drop-shadow(0 0 12px rgba(0, 212, 255, 0.9));
                transform: scale(1.15);
            }

            /* Card Icons */
            body[data-theme="marketing-bot-dashboard"] .lqd-card svg,
            body[data-theme="marketing-bot-dashboard"] [class*="card"] svg {
                filter: drop-shadow(0 0 6px rgba(0, 212, 255, 0.4));
                transition: all 0.3s ease;
            }

            body[data-theme="marketing-bot-dashboard"] .lqd-card:hover svg,
            body[data-theme="marketing-bot-dashboard"] [class*="card"]:hover svg {
                filter: drop-shadow(0 0 12px rgba(0, 212, 255, 0.8));
                transform: scale(1.1);
            }

            /* Form Icons */
            body[data-theme="marketing-bot-dashboard"] .lqd-form svg,
            body[data-theme="marketing-bot-dashboard"] form svg {
                filter: drop-shadow(0 0 5px rgba(0, 212, 255, 0.4));
            }

            /* Dropdown Icons */
            body[data-theme="marketing-bot-dashboard"] .lqd-dropdown svg {
                filter: drop-shadow(0 0 6px rgba(0, 212, 255, 0.5));
            }

            body[data-theme="marketing-bot-dashboard"] .lqd-dropdown:hover svg {
                filter: drop-shadow(0 0 10px rgba(0, 212, 255, 0.8));
            }

            /* Modal Icons */
            body[data-theme="marketing-bot-dashboard"] .modal svg,
            body[data-theme="marketing-bot-dashboard"] .lqd-modal svg {
                filter: drop-shadow(0 0 6px rgba(0, 212, 255, 0.5));
            }

            /* Chat Sidebar Search */
            body[data-theme="marketing-bot-dashboard"] .chats-search {
                background: transparent !important;
            }

            body[data-theme="marketing-bot-dashboard"] .chats-search-form {
                position: relative;
            }
